...
const Privacy = () => {
  return (
    <div className="mx-auto my-8 p-3">
      ...
      <br />
      <br />
      Clay Music (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates
      the http://www.claymusic.org website (the &quot;Service&quot;).
      <br />
      <br />
      ...
      accessible from http://www.claymusic.org
      <br />
      <br />
      <div className="text-2xl font-bold">Information Collection And Use</div>
      <br />
      We collect several different types of information for various purposes to
      provide and improve our Service to you.
      <br />
      <br />
      <div className="text-xl font-bold mb-2">Types of Data Collected</div>
      <div className="text-lg font-bold mb-2">Personal Data</div>
      ...
      <br />
      <div className="font-bold mb-2">Usage Data</div>
      ...
      your computer’s Internet Protocol address (e.g. IP address), browser type,
      browser version, the pages of our Service that you visit, the time and
      date of your visit, the time spent on those pages, unique device
      identifiers and other diagnostic data.
      <br />
      <br />
      <div className="font-bold mb-2">Tracking &amp; Cookies Data</div>
      ...
      <br />
      <div className="text-2xl font-bold mb-2">Use of Data</div>
      Clay Music uses the collected data for various purposes:
      <br />
      <br />
      <ul>
      ...
      <br />
      <div className="text-2xl font-bold mb-2">Transfer Of Data</div>
      ...
      <br />
      <br />
      Clay Music will take all steps reasonably necessary to ensure that your
      ...
      <br />
      <br />
      <div className="text-2xl font-bold mb-2">Disclosure Of Data</div>
      <div className="text-xl mb-2">Legal Requirements</div>
      Clay Music may disclose your Personal Data in the good faith belief that
      such action is necessary to:
      <br />
      <br />
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Clay Music</li>
        <li>
      ...
      <br />
      <div className="text-2xl font-bold mb-2">Security Of Data</div>
      ...
      <br />
      <br />
      <div className="text-2xl font-bold mb-2">Service Providers</div>
      ...
      <br />
      <br />
      <div className="text-2xl font-bold mb-2">Links To Other Sites</div>
      ...
      <br />
      <br />
      <div className="text-2xl font-bold mb-2">Children’s Privacy</div>
